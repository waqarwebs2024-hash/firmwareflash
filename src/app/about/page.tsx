...
export const metadata: Metadata = {
  title: 'About Firmware Finder',
  description: 'Learn about Firmware Finder, our mission, our values, and the team dedicated to providing reliable and accessible firmware downloads for everyone.',
};
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground">
              To provide a comprehensive, secure, and user-friendly database of official firmware for the widest possible range of mobile devices, free of charge.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground">
              We prioritize security, accessibility, and reliability. Every file is sourced carefully, and our guides are written to be clear and easy to follow for all skill levels.
            </p>
          </div>
          <div className="flex flex-col items-center">
