...
export default async function Home() {
    ...
    const OppoLogo = () => (
      <svg role="img" aria-label="Oppo Logo">
        <svg
          viewBox="0 0 120 36"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-auto text-[#1DAB60] dark:text-white"
        >
          <path
            d="M18.15 35.82C8.16 35.82 0 27.79 0 17.91S8.16 0 18.15 0s18.15 7.92 18.15 17.91-8.16 17.91-18.15 17.91zm0-29.85c-6.57 0-11.9 5.28-11.9 11.94s5.33 11.94 11.9 11.94 11.9-5.28 11.9-11.94S24.72 5.97 18.15 5.97zM83.82 35.82c-9.99 0-18.15-7.92-18.15-17.91s8.16-17.91 18.15-17.91 18.15 7.92 18.15 17.91-8.16 17.91-18.15 17.91zm0-29.85c-6.57 0-11.9 5.28-11.9 11.94s5.33 11.94 11.9 11.94 11.9-5.28 11.9-11.94-5.33-11.94-11.9-11.94zM53.18 35.31h-7.1L42.2 6.48h6.8l2.1 21.36.04.6h.22l5.42-21.96h6.82L53.18 35.3z"
            fill="currentColor"
          ></path>
          <path
            d="M113.14 18.17a1.2 1.2 0 00-1.15-1.24h-1.4a1.2 1.2 0 00-1.16 1.24v.9c0 .68.51 1.24 1.16 1.24h1.4c.64 0 1.15-.56 1.15-1.24v-.9z"
            fill="currentColor"
          ></path>
        </svg>
      </svg>
